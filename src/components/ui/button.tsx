...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variants: Record<string, string> = {
      ...
      outline:
        'border-2 border-brand-navy dark:border-white/40 text-brand-navy dark:text-white/90 hover:bg-brand-navy hover:text-white dark:hover:bg-white/10 dark:hover:border-white focus-visible:outline-brand-navy active:scale-[0.98]',
      ghost:
        'text-brand-navy dark:text-white/80 hover:bg-brand-navy/5 dark:hover:bg-white/10 focus-visible:outline-brand-navy',
      whatsapp:
