    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
        {loading ? (
          ...
          albums.map(album => (
            <div key={album.id} className="bg-white rounded-xl border border-border-light shadow-sm overflow-hidden hover:shadow-md transition group">
              <div className="h-40 bg-gradient-to-br from-brand-navy/10 to-brand-green/10 flex items-center justify-center relative">
                ...
                <div className="absolute top-3 right-3">
                  <span className={`text-[10px] font-bold uppercase tracking-wider px-2 py-1 rounded border ${album.published ? 'bg-green-50 text-green-700 border-green-200' : 'bg-gray-50 text-gray-500 border-gray-200'}`}>
