      ...
      <section className="section-padding">
        <div className="container-narrow text-center">
          <div className="card p-12">
            <Calendar className="w-12 h-12 text-brand-navy/20 mx-auto mb-4" />
            <h2 className="font-heading font-bold text-2xl text-brand-deep-navy mb-3">No Scheduled Events</h2>
