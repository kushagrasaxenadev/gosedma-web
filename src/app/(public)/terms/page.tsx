    ...
    <section className="section-padding">
      <div className="container-narrow">
        ...
        <div className="space-y-8 text-foreground-secondary leading-relaxed">
          ...
          <div>
            <h2 className="font-heading font-bold text-xl text-foreground mb-3">1. Use of Website</h2>
            <p>This website is operated by GOSEDMA ({SITE_CONFIG.fullName}). By using this website, you agree to these terms.</p>
          </div>

          <div>
            <h2 className="font-heading font-bold text-xl text-foreground mb-3">2. Training Services</h2>
          ...
          <div>
            <h2 className="font-heading font-bold text-xl text-foreground mb-3">3. Enquiry Forms</h2>
          ...
          <div>
            <h2 className="font-heading font-bold text-xl text-foreground mb-3">4. Intellectual Property</h2>
