    ...
    <section className="section-padding">
      <div className="container-narrow">
        ...
        <div className="space-y-8 text-foreground-secondary leading-relaxed">
          ...
          <div>
            <h2 className="font-heading font-bold text-xl text-foreground mb-3">Physical Activity Risk</h2>
          ...
          <div>
            <h2 className="font-heading font-bold text-xl text-foreground mb-3">Medical Clearance</h2>
          ...
          <div>
            <h2 className="font-heading font-bold text-xl text-foreground mb-3">Minors</h2>
          ...
          <div>
            <h2 className="font-heading font-bold text-xl text-foreground mb-3">Responsible Use of Training</h2>
          ...
          <div>
            <h2 className="font-heading font-bold text-xl text-foreground mb-3">Contact</h2>
